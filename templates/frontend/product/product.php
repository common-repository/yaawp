        ...
        <div id="content" role="main">
            ...
            <div class="product-view" style="margin: 0; padding: 0;">
                ...
                <?php
                    ...
                    if ( !empty($content) ):
                ?>
                    <div style="margin: 0;border: 1px solid #CCC;padding: 12px 10px;box-shadow: 0 0 5px #CCC;font-size: 12px;">
                        <?php echo $content; ?>
                    </div>
                ...
                <div style="margin: 15px 0 0 0;border: 1px solid #CCC;padding: 12px 10px;box-shadow: 0 0 5px #CCC;font-size: 12px;">
                    <?php echo $amazon; ?>
                </div>
